...
- **Supabase** — backend service that provides authentication, database, and storage. Your account data, lists, items, and collaboration data are stored in Supabase.
- **Apple Push Notification service (APNs)**, operated by Apple Inc. — used to deliver push notifications to your device.
- **Sentry** (Functional Software, Inc., d/b/a Sentry) — used for crash reporting and error monitoring as described in Section 2. Sentry processes diagnostic data on our behalf and stores it on its infrastructure.
